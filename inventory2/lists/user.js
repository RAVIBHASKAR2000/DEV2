...
import { Text, Checkbox, Password, Slug, File, Url, Virtual, Select, Relationship } from '@keystonejs/fields';
...
import { avatarAdapter } from '../lib/list/adapters';
...
export const User = {
  ...
  fields: {
    ...
    image: { type: File, adapter: avatarAdapter },
    twitter: { type: Text, width: "short" },
    bio: { type: Wysiwyg },
    mobile: { type: Text, label: "mobile number", min: 9, max: 11 },
    gravatar: { type: Text, noedit: true },
    userType: {type: Select, options: 'Bussiness, Customer',},
    wishlist: {type:Relationship, ref:'Wishlist'},
    address: {type:Relationship, ref:'Address', many: true,},
    savedCard:{type:Relationship,ref:'SavedCard'},
    incompleteCheckout :{type: Text},
    isAdmin: {
      type: Checkbox,
