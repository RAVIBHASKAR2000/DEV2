...
export const createLists = keystone => {
  ...
  //   fields: {
  //     name :{type : Text},
  //     user : { type: Relationship, ref: 'User.yourcity', many: true},
  //     state : { type: Relationship, ref: 'State.city' },
      
  //   },
  // });


  keystone.createList('Prabhar',{
    access: defaultAccess,
    fields: {
     
      prabharName: {type: Select, 
        options:[
                    'संयोजक', 
                    'संरक्षण', 
                    'पुर्व राष्ट्रीय अध्यक्ष', 
                    'राष्ट्रीय अध्यक्ष', 
                    'राष्ट्रीय कार्यकारी अध्यक्ष', 
                    'राष्ट्रीय उपाध्यक्ष', 
                    'राष्ट्रीय महामंत्री',
                    'राष्ट्रीय कोषाध्यक्ष', 
                    'राष्ट्रीय मीडिया प्रभारी राष्ट्रीय मंत्री', 
                    'राष्ट्रीय सलाहकार', 
                    'अखिल भारतीय क्षत्रिय महासभा राष्ट्रीय प्रचार', 
                    'आईटी सेल', 
      ...
      prabharLevel: { type: Select,
              options: ['National', 'State', 'District'],
              defaultValue: 'State',},
              
      currentPrabhari :{ type: Relationship, ref : 'Prabhari'},        
   
    },
    labelField: 'prabharName', 
  });
   
  
  keystone.createList('Prabhari', {
    access: defaultAccess,
    fields: {
      ...
      currentlyWorking: { type: Checkbox, isRequired: false},   
      
    
      mobile: { type: Text},

      prabhar: { type: Relationship, ref:'Prabhar', many :false },
